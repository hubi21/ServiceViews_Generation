...
###An example of a weighted schema graph, such the weights represent the matching score on the service' attributes
G=nx.DiGraph()
...
###The set of service parameters we're looking for
parameters=['title','isbn10', 'isbn13', 'name','available_quantity','price','seller','author','publisher','country','rating']
